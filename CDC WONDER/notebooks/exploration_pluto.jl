...
# ╔═╡ 8915ebed-619a-4918-a773-203c2301dc4c
begin
	using CSV
	using DataFrames
	using PrettyTables
...
# ╔═╡ f73f2e1d-4e9f-4dbb-bb66-38b330a2a913
html"<style>
main {
    max-width:75%;
    padding: unset;
...
# ╔═╡ 575c111e-aa5f-4ac5-8831-5c0f8e0b24d8
md"""
## Loading Packages
"""

# ╔═╡ 8c5f3594-6d80-4e4a-94b4-afa74e4548e8
md"""
## Creating a variable to readily access the `datadir`
"""

# ╔═╡ 6e884a09-342b-46b1-8584-8dd4839cef78
data_dir = join(split(@__DIR__,"/")[1:end-1],"/")*"/data/" ;

# ╔═╡ 2a01e985-0adb-4d42-be40-b0ae2a9d8bbe
md"""
...
- [`PlutoUI`](https://github.com/fonsp/PlutoUI.jl) - A package to add cool UI elements to Pluto like the terminal.
...
# ╔═╡ 9f5a1a27-251b-4aa0-9612-5ab4914d0d8e
df = CSV.File(data_dir*"exp_raw/"*"ny_2007_2019.txt"; limit = 29, drop = ["Notes"]) |> DataFrame

# ╔═╡ f93c5286-bfe1-435d-b561-c82c4c483425
CSV.write(data_dir*"exp_pro/"*"ny_2007_2019_processed.csv", df);

# ╔═╡ bf57d22c-458c-49a2-b6de-1c3bbe0a632d
md"""
...
# ╔═╡ cc012427-dc4a-4f32-934b-6e7f059ab451
df_mod = CSV.File(data_dir*"exp_pro/"*"ny_2007_2019_processed.csv") |> DataFrame

# ╔═╡ d6ed2d6b-2feb-42f3-af73-c4e4a4d3efc7
md"""
### Finding Most Populuous Counties
"""

# ╔═╡ 584b0e6d-6a51-47dc-9147-ab3fca06f7cf
sort!(df_mod, Symbol("Total Population"), rev = true)

# ╔═╡ 30f29d6f-6410-43ad-ad6b-e52478db69d1
names = ["County", "Total Population"]

# ╔═╡ ad86c11d-0372-4bde-add7-a56d728c8d94
tab = Any[
...
# ╔═╡ ada1fe1b-da0a-4a1d-8368-53eca38afb13
